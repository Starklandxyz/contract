        ...
        fn execute(self: @ContractState) {
            ...
            set!(
                ...
                (
                    WarriorConfig {
                        map_id: 1,
                        Train_Food: 50 * multiplier,
                        Train_Gold: 20 * multiplier,
                        Train_Iron: 4 * multiplier,
                        Train_Time: 30,
            ...
            set!(
                ...
                (MiningConfig {
                    ...
                    Base_Gold_Speed: multiplier / 4,
                    Base_Food_Speed: multiplier / 4,
                    Base_Iron_Speed: multiplier / 4,
                })
            );
            set!(
                world,
